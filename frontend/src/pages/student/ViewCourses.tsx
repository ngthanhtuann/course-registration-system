...
export default function ViewCourses({ user }: { user: Student }) {
      ...
      >
        {view && (
          <div className="grid grid-cols-2 gap-3">
            {[
              ["Code", view.course_code],
              ["Name", view.course_name],
              ["Credits", view.credit],
              ["Prerequisite", view.prerequisite_name || "None"],
              ["Recommended Semester", view.recommended_semester],
              ["Capacity", view.max_capacity],
            ].map(([k, v]) => (
              <div key={String(k)} className="bg-slate-50 p-3 rounded">
